 ...
 * Disallow adding `__activity`, `__check_uuid`, `__name`, and `__type` tags in check tags and ignore them
 ...
 * Improvements to the surrogate format for transmission during reconstitute and
   rebalance.
