...
CUA for MacOS includes a turnkey [service dashboard](/circonus/dashboards/introduction/#service-dashboards).

![Image: 'macos-dashboard-system.png'](../../../img/macos-dashboard-system.png)
